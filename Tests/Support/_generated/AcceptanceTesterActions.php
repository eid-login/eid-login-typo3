<?php
 ...
 //[STAMP] 89d56f56f6d80ff76b8ec8d1e8c23936
...
trait AcceptanceTesterActions
{
     ...
     *
     *
     * @see \Helper\Acceptance::fetchSkidMetaData()
     */
    public function fetchSkidMetaData()
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('fetchSkidMetaData', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Helper\Acceptance::fetchSkidMetaData()
     */
    public function tryToFetchSkidMetaData()
    {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('fetchSkidMetaData', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes fetchSkidMetaData and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Helper\Acceptance::fetchSkidMetaData()
     */
    public function retryFetchSkidMetaData()
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('fetchSkidMetaData', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \Helper\Acceptance::setConfiguration()
     */
    public function setConfiguration(\Codeception\Actor $I, string $configType)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('setConfiguration', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Helper\Acceptance::setConfiguration()
     */
    public function tryToSetConfiguration(\Codeception\Actor $I, string $configType)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('setConfiguration', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes setConfiguration and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Helper\Acceptance::setConfiguration()
     */
    public function retrySetConfiguration(\Codeception\Actor $I, string $configType)
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('setConfiguration', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \TYPO3\TestingFramework\Core\Acceptance\Helper\Login::useExistingSession()
     */
    public function tryToUseExistingSession($role = '')
    {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('useExistingSession', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes useExistingSession and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \TYPO3\TestingFramework\Core\Acceptance\Helper\Login::useExistingSession()
     */
    public function retryUseExistingSession($role = '')
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('useExistingSession', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \Codeception\Module\Cli::runShellCommand()
     */
    public function tryToRunShellCommand($command, $failNonZero = true)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('runShellCommand', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes runShellCommand and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Codeception\Module\Cli::runShellCommand()
     */
    public function retryRunShellCommand($command, $failNonZero = true)
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('runShellCommand', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \Codeception\Module\Cli::seeInShellOutput()
     */
    public function tryToSeeInShellOutput($text)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('seeInShellOutput', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes seeInShellOutput and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Codeception\Module\Cli::seeInShellOutput()
     */
    public function retrySeeInShellOutput($text)
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('seeInShellOutput', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \Codeception\Module\Cli::dontSeeInShellOutput()
     */
    public function tryToDontSeeInShellOutput($text)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('dontSeeInShellOutput', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes dontSeeInShellOutput and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Codeception\Module\Cli::dontSeeInShellOutput()
     */
    public function retryDontSeeInShellOutput($text)
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('dontSeeInShellOutput', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \Codeception\Module\Cli::seeShellOutputMatches()
     */
    public function tryToSeeShellOutputMatches($regex)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('seeShellOutputMatches', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes seeShellOutputMatches and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Codeception\Module\Cli::seeShellOutputMatches()
     */
    public function retrySeeShellOutputMatches($regex)
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('seeShellOutputMatches', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     *
     * * Executes grabShellOutput and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Codeception\Module\Cli::grabShellOutput()
     */
    public function retryGrabShellOutput()
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('grabShellOutput', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \Codeception\Module\Cli::seeResultCodeIs()
     */
    public function tryToSeeResultCodeIs($code)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('seeResultCodeIs', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes seeResultCodeIs and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Codeception\Module\Cli::seeResultCodeIs()
     */
    public function retrySeeResultCodeIs($code)
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('seeResultCodeIs', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \Codeception\Module\Cli::seeResultCodeIsNot()
     */
    public function tryToSeeResultCodeIsNot($code)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('seeResultCodeIsNot', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes seeResultCodeIsNot and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Codeception\Module\Cli::seeResultCodeIsNot()
     */
    public function retrySeeResultCodeIsNot($code)
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('seeResultCodeIsNot', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \Codeception\Module\Db::seeInDatabase()
     */
    public function tryToSeeInDatabase($table, $criteria = [])
    {
     ...
     * @see \Codeception\Module\Db::seeInDatabase()
     */
    public function retrySeeInDatabase($table, $criteria = [])
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Db::seeNumRecords()
     */
    public function tryToSeeNumRecords($expectedNumber, $table, array $criteria = [])
    {
     ...
     * @see \Codeception\Module\Db::seeNumRecords()
     */
    public function retrySeeNumRecords($expectedNumber, $table, array $criteria = [])
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Db::dontSeeInDatabase()
     */
    public function tryToDontSeeInDatabase($table, $criteria = [])
    {
     ...
     * @see \Codeception\Module\Db::dontSeeInDatabase()
     */
    public function retryDontSeeInDatabase($table, $criteria = [])
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Db::grabColumnFromDatabase()
     */
    public function retryGrabColumnFromDatabase($table, $column, array $criteria = [])
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Db::grabFromDatabase()
     */
    public function retryGrabFromDatabase($table, $column, $criteria = [])
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Db::grabNumRecords()
     */
    public function retryGrabNumRecords($table, array $criteria = [])
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Db::updateInDatabase()
     */
    public function tryToUpdateInDatabase($table, array $data, array $criteria = [])
    {
     ...
     * @see \Codeception\Module\Db::updateInDatabase()
     */
    public function retryUpdateInDatabase($table, array $data, array $criteria = [])
    {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
