 ...
 *
 *    $des = new \Ecsec\Eidlogin\Dep\phpseclib\Crypt\DES();
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends Base
{
     ...
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Crypt\DES::_processBlock()
     */
    /**
     ...
     *
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Crypt\Base::openssl_mode_names
     * @var array
     * @access private
     */
     ...
     *
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Crypt\Base::isValidEngine()
     * @param int $engine
     * @access public
     * @return bool
     */
