 ...
 *
 *    $rsa = new \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA();
...
class RSA
{
    ...
    */
    ...
    /**#@+
     * @access private
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA::createKey()
    */
    /**
     * ASN1 Integer
     */
    ...
    /**#@+
     * @access private
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA::__construct()
    */
    /**
     ...
     * @access public
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA::createKey()
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA::setPrivateKeyFormat()
    */
    /**
     ...
     * @access public
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA::createKey()
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA::setPublicKeyFormat()
    */
    /**
     * Raw public key
     *
     * An array containing two \Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger objects.
     *
     ...
     * Precomputed Zero
     *
     * @var \Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger
     * @access private
     */
    var $zero;
     ...
     * Hash function
     *
     * @var \Ecsec\Eidlogin\Dep\phpseclib\Crypt\Hash
     * @access private
     */
    var $hash;
     ...
     * \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA doesn't do it is because OpenSSL doesn't fail gracefully.  openssl_pkey_new(), in particular, requires
     * openssl.cnf be present somewhere and, unfortunately, the only real way to find out is too late.
     *
     * @return \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA
     * @access public
     */
     ...
     *                  Will need to be passed back to \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA::createKey() as the third parameter for further processing.
     *
     * @access public
     * @param int $bits
     * @param int $timeout
     ...
     * exponent this won't work unless you manually add the public exponent. Ecsec\Eidlogin\Dep\phpseclib tries to guess if the key being used
     ...
     *
     * If Ecsec\Eidlogin\Dep\phpseclib guessed a private key was a public key and loaded it as such it might be desirable to force
     * Ecsec\Eidlogin\Dep\phpseclib to treat the key as a private key. This function will do that.
     *
     * Do note that when a new key is loaded the index will be cleared.
     *
     * Returns true on success, false on failure
    ...
    {
        // \Ecsec\Eidlogin\Dep\phpseclib\Crypt\Hash supports algorithms that PKCS#1 doesn't support.  md5-96 and sha1-96, for example.
        switch ($hash) {
            case 'md2':
            case 'md5':
            case 'sha1':
     ...
     *
     * @access private
     * @param \Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger $x
     * @param int $xLen
     * @return string
     */
     ...
     * @return \Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger
     */
    function _os2ip($x)
    {
     ...
     * @access private
     * @param \Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger $x
     * @param \Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger $r
     * @param int $i
     * @return \Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger
     */
     ...
     *
     * @access private
     * @param \Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger $m
     * @return \Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger
     */
    function _rsaep($m)
    {
     ...
     *
     * @access private
     * @param \Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger $c
     * @return \Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger
     */
    function _rsadp($c)
    {
     ...
     *
     * @access private
     * @param \Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger $s
     * @return \Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger
     */
    function _rsavp1($s)
    {
     ...
     *
     * As a consequence of this, a private key encrypted ciphertext produced with \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA may not decrypt
