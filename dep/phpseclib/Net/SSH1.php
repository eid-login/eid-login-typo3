 ...
 *
 *    $ssh = new \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH1('www.domain.tld');
...
use Ecsec\Eidlogin\Dep\phpseclib\Crypt\DES;
...
class SSH1
{
     ...
     * Encryption Methods
     *
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH1::getSupportedCiphers()
     * @access public
     */
    /**
     * No encryption
     ...
     *
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH1::getSupportedAuthentications()
     * @access public
    */
    /**
    ...
    */
     ...
     * The Response Type
     *
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH1::_get_binary_packet()
     * @access private
     */
     ...
     *
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH1::bitmap
     * @access private
    */
    ...
    /**#@+
     * @access public
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH1::getLog()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH1::read()
    */
    /**
     ...
     * @param int $timeout
     * @param int $cipher
     * @return \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH1
     * @access public
     */
    ...
    function _connect()
    {
        ...
        switch ($cipher) {
            ...
            //    $this->crypto = new \Ecsec\Eidlogin\Dep\phpseclib\Crypt\Null();
            //    break;
     ...
     *
     * To execute further commands, a new \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH1 object will need to be created.
     *
    ...
    function exec($cmd, $block = true)
    {
        ...
        // reset the execution bitmap - a new \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH1 object needs to be created.
        $this->bitmap = 0;
