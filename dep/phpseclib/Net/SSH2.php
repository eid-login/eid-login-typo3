 ...
 *
 *    $ssh = new \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = new \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA();
...
namespace Ecsec\Eidlogin\Dep\phpseclib\Net;

use Ecsec\Eidlogin\Dep\phpseclib\Crypt\Base;
use Ecsec\Eidlogin\Dep\phpseclib\Crypt\Blowfish;
use Ecsec\Eidlogin\Dep\phpseclib\Crypt\Hash;
use Ecsec\Eidlogin\Dep\phpseclib\Crypt\Random;
use Ecsec\Eidlogin\Dep\phpseclib\Crypt\RC4;
use Ecsec\Eidlogin\Dep\phpseclib\Crypt\Rijndael;
use Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA;
use Ecsec\Eidlogin\Dep\phpseclib\Crypt\TripleDES;
use Ecsec\Eidlogin\Dep\phpseclib\Crypt\Twofish;
use Ecsec\Eidlogin\Dep\phpseclib\Math\BigInteger; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use Ecsec\Eidlogin\Dep\phpseclib\System\SSH\Agent;
...
class SSH2
{
     ...
     *
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH2::bitmap
     * @access private
     */
     ...
     *     the other side.
     *
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH2::_send_channel_packet()
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH2::_get_channel_packet()
     * @access private
    */
    ...
    /**#@+
     * @access public
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH2::getLog()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH2::read()
    */
    /**
     ...
     * @param int $timeout
     * @see self::login()
     * @return \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH2
     * @access public
     */
     ...
     * \Ecsec\Eidlogin\Dep\phpseclib\Crypt\Base.
     *
     * @param string $algorithm Name of the encryption algorithm
     * @return mixed Instance of \Ecsec\Eidlogin\Dep\phpseclib\Crypt\Base or null for unknown
     * @access private
     */
     ...
     * Login
     *
     * The $password parameter can be a plaintext password, a \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA object or an array
     *
    ...
    function _keyboard_interactive_process()
    {
        ...
        switch ($type) {
            case NET_SSH2_MSG_USERAUTH_INFO_REQUEST:
                ...
                */
                // maybe Ecsec\Eidlogin\Dep\phpseclib should force close the connection after x request / responses?  unless something like that is done
     ...
     *
     * @param string $username
     * @param \Ecsec\Eidlogin\Dep\phpseclib\System\SSH\Agent $agent
     * @return bool
     * @access private
     */
     ...
     *
     * @param string $username
     * @param \Ecsec\Eidlogin\Dep\phpseclib\Crypt\RSA $privatekey
     * @return bool
     * @access private
     * @internal It might be worthwhile, at some point, to protect against {@link http://tools.ietf.org/html/rfc4251#section-9.3.9 traffic analysis}
     *           by sending dummy SSH_MSG_IGNORE messages.
     ...
     * Execute Command
     *
     * If $callback is set to false then \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH2::_get_channel_packet(self::CHANNEL_EXEC) will need to be called manually.
    ...
    function exec($command, $callback = null)
    {
        ...
        // down.  the one place where it might be desirable is if you're doing something like \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH2::exec('ping localhost &').
     ...
     *
     * \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH2 doesn't properly close most channels.  For exec() channels are normally closed by the server
    ...
    /**
     * Returns a list of KEX algorithms that Ecsec\Eidlogin\Dep\phpseclib supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of host key algorithms that Ecsec\Eidlogin\Dep\phpseclib supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of symmetric key algorithms that Ecsec\Eidlogin\Dep\phpseclib supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of MAC algorithms that Ecsec\Eidlogin\Dep\phpseclib supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of compression algorithms that Ecsec\Eidlogin\Dep\phpseclib supports
     *
     * @return array
     * @access public
     */
