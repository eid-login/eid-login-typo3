 ...
 *        exit('bad login');
 *    }
 *    $scp = new \Ecsec\Eidlogin\Dep\phpseclib\Net\SCP($ssh);
 *
...
class SCP
{
    /**#@+
     * @access public
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SCP::put()
     */
    /**
    ...
    /**#@+
     * @access private
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SCP::_send()
     * @see \Ecsec\Eidlogin\Dep\phpseclib\Net\SCP::_receive()
    */
    /**
     * SSH1 is being used.
     */
     ...
     *
     * @param \Ecsec\Eidlogin\Dep\phpseclib\Net\SSH1|\Ecsec\Eidlogin\Dep\phpseclib\Net\SSH2 $ssh
     * @return \Ecsec\Eidlogin\Dep\phpseclib\Net\SCP
     * @access public
     */
     ...
     *
     * By default, \Ecsec\Eidlogin\Dep\phpseclib\Net\SCP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \Ecsec\Eidlogin\Dep\phpseclib\Net\SCP::get(), you will get a file, twelve bytes
